...
public class ServerAct extends Activity {
	...
	private void fillData() throws Exception {
		...
		appendMessage("系统已准备好连接到：" + param.getIp());
	...
	class DownloadThread extends Thread {
		...
		public void run() {
			...
			if (cmt.saveImage()) {	
				Looper.prepare();
				ActivityUtil.openToast(ServerAct.this, "保存成功！");
			} else {
				Looper.prepare();
				ActivityUtil.openToast(ServerAct.this, "保存失败！");
			}
			// 
	//		 handler.post(new Runnable(){
		...
		//	 }
		//	 ActivityUtil.openToast(ServerAct.this, "下载完成");
		//	 try{
		//	 // getData(handler);	 
		//	 }catch (Exception e) {
